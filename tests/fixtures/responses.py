...
class FakeResponse:
    def __init__(self, status_code: int = 200, text: str = None, json: Any = None):
...
info_response = {"authorization_endpoint": "https://uaa.example.com"}
...
instances = {"0": {"state": "RUNNING", "uptime": 92660, "since": 1515413624}}
...
bind = {
    ...
    "entity": {"name": "my-bind", "production": False},
}
